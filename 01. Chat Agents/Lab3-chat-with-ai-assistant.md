...
4. 채팅 하단의 사용 가능한 옵션을 확인하고 마우스를 올려보세요:
   - **All data and apps**: 조직의 데이터 소스, 대시보드, 통합 애플리케이션에 접근하거나 AI의 일반 지식과 직접 상호작용
...
1. 채팅 인터페이스에서 **All data and apps**를 선택합니다.
...
**다음**: 다음 섹션에서는 채팅에서 직접 문서를 업로드하고 분석하는 방법을 배웁니다.
